...
class CulturalHeritageBookController extends Controller
{
    public function index()
    {
        ...
        return inertia('Admin/Books/CulturalHeritage', [
            'books' => $books,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('file_path')) {
            $data['file_path'] = $request->file('file_path')->store('books/culturalheritage_books', 'public');
        }
