...
<template>
    <GuestLayout>
        ...
        <div class="container py-4">
            <div
                class="card shadow-lg border-0 rounded-4 bg-white-green reset-card-animate position-relative small-card"
            >
...
.reset-card-animate:hover,
.reset-card-animate:focus-within {
