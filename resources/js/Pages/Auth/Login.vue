            ...
            <div class="card shadow-lg border-0 rounded-4 bg-white-green login-card-animate position-relative small-card">
                ...
                <div class="card-body p-4">
                    <h2 class="text-center mb-3 fw-bold text-success" style="font-size:1.5rem;">
                        <i class="fa-solid fa-right-to-bracket me-2"></i>Login to Your Account
                    </h2>
                    <form @submit.prevent="submitForm">
                        ...
                        <div class="text-center mt-3" style="font-size:0.97rem;">
                            <p>
                                ...
                                <Link href="/register" class="link-green">Register</Link>
                            </p>
                            <p>
...
.login-card-animate:hover, .login-card-animate:focus-within {
