        ...
        <div class="container py-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="fw-bold mb-0">
                    <i class="fas fa-archive me-2 text-success"></i> Digital
                    Archive
                </h2>
            ...
            <div class="card shadow-sm">
                <div class="card-body p-0">
                    ...
                    >
                        ...
                        <p class="text-muted">
                            Upload barangay documents, photos, or records for
                            the community.
                        </p>
                    </div>
                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                >
                                    <td>
                                        <i
                                            :class="fileTypeIcon(archive.type)"
                                            class="me-2"
                                        ></i>
                                        {{ archive.type }}
                                    </td>
                                    ...
                                    <td>
                                        <template
                                            v-if="
                                                archive.file_path &&
                                                archive.file_path.match(
                                                    /\.(jpg|jpeg|png)$/i
                                                )
                                            "
                                        >
                                            <img
                                                :src="`/storage/${archive.file_path}`"
                                                alt="Preview"
                                                style="
                                                    width: 40px;
                                                    height: 40px;
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-success" @click="handleUpload">
                            Upload
                        </button>
                    </div>
                </div>
