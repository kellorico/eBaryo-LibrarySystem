    ...
    <AdminLayout>
        ...
        <div class="container">
            <h2 class="fw-bold mb-4">
                <i class="fa fa-trophy text-warning me-2"></i>Manage Reading
                Challenges
            </h2>
            <form @submit.prevent="submit" class="card p-4 mb-4 shadow-sm">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input
                            v-model="form.target_books"
                            type="number"
                            min="1"
                            class="form-control"
                        />
                        <div
                            v-if="form.errors.target_books"
                            class="text-danger small mt-1"
                        >
                            {{ form.errors.target_books }}
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="card shadow-sm mt-4">
                <div
                    class="card-header bg-warning text-white fw-bold d-flex align-items-center gap-2"
                >
                ...
                <div class="table-responsive">
                    <table class="table table-striped mb-0 align-middle">
                        ...
                        <tbody>
                            <tr
                                v-for="(c, i) in props.challenges.data"
                                :key="c.id"
                            >
                                <td>{{ i + 1 }}</td>
                                <td>{{ c.title }}</td>
