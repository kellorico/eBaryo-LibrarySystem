...
const filteredUsers = computed(() => {
    if (!search.value) return page.props.verifiedUsers;
    return page.props.verifiedUsers.filter(user => {
                    ...
                    >
                        <div class="mb-3 mb-md-0">
                            ...
                            <p class="text-muted mb-0">
                                Manage users who have been verified and approved
                            </p>
                        </div>
                        <div class="d-flex align-items-center">
                            <span
                                class="badge bg-success bg-opacity-10 text-success me-3 px-3 py-2"
                            >
                                <i class="fas fa-check-circle me-1"></i>
                                {{ page.props.verifiedUsers?.length || 0 }}
                                Verified
                            </span>
                        </div>
                    </div>
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td class="d-flex align-items-center gap-2">
                            ...
                            <i
                                v-else
                                class="fas fa-user-check text-success bg-light p-2 rounded-circle"
                                style="
                                    width: 40px;
                                    height: 40px;
                                    font-size: 1.5rem;
