...
const handleDeleteBook = (book) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            router.delete(`/books/educational/${book.id}`, {
                preserveScroll: true,
                onSuccess: () => {
                    Swal.fire({
                        icon: "success",
    ...
    <AdminLayout>
        ...
        <div class="container-fluid">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                        <div class="mb-3 mb-md-0">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <h1 class="h2 fw-bold text-dark mb-0">Educational Books</h1>
                            </div>
                            <p class="text-muted mb-0">Manage your collection of educational resources and textbooks</p>
                        </div>
                        <button 
            ...
            <div v-if="books.length === 0" class="text-center py-5">
                ...
                <h3 class="h5 fw-semibold text-dark mb-2">No educational books yet</h3>
                <p class="text-muted mb-4">Get started by adding your first educational book to the collection.</p>
                <button 
