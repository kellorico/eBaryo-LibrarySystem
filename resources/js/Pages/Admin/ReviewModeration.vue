...
const handleAction = (id, action, note = null) => {
    ...
    Swal.fire({
        ...
        inputLabel:
            action === "reject" ? "Reason for rejection (optional)" : undefined,
        inputValue: note || "",
    }).then((result) => {
...
const handleBulkAction = (action) => {
    ...
    if (action === "dismiss")
        confirmText = "Dismiss reports for selected reviews?";
    Swal.fire({
        title: "Are you sure?",
        text: confirmText,
        icon: "question",
        ...
        <div class="container">
                        ...
                        <div class="col-md-4">
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                    <button
                                        class="btn btn-xs btn-link text-danger p-0 ms-2"
            ...
            <div class="mb-2">
                ...
                <button
                    ...
                    @click="() => handleBulkAction('dismiss')"
                    :disabled="selected.length === 0"
                >
                    Dismiss Reports
                </button>
                    ...
                    <table class="table table-striped mb-0">
                        ...
                        <tbody>
                            <tr v-for="review in reviews.data" :key="review.id">
                                ...
                                <td
                                    v-html="
                                        highlightText(review.review, search)
                                    "
                                ></td>
                                <td>
                                    <span
            ...
            <nav v-if="reviews.meta && reviews.meta.last_page > 1" class="mt-3">
                <ul class="pagination justify-content-center">
                    <li
                        class="page-item"
                        :class="{ disabled: !reviews.links.prev }"
                    >
                        <a
                            class="page-link"
                            href="#"
                            @click.prevent="router.get(reviews.links.prev)"
                            tabindex="-1"
                            >Previous</a
                        >
                    </li>
                    ...
                    >
                        <a
                            ...
                            href="#"
                            @click.prevent="
                                router.get(reviews.links.path + '?page=' + page)
                            "
                            >{{ page }}</a
                        >
                    </li>
                    <li
                        class="page-item"
                        :class="{ disabled: !reviews.links.next }"
                    >
                        <a
                            class="page-link"
                            href="#"
                            @click.prevent="router.get(reviews.links.next)"
                            >Next</a
                        >
                    </li>
                </ul>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-2">
                                <strong>User:</strong>
                                {{ modalReview.user?.name || "Unknown" }}
                            </div>
                            <div class="mb-2">
                                <strong>Book:</strong>
                                {{ modalReview.book?.title || "Unknown" }}
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                ...
                                <span
                                    :class="{
                                        ...
                                        'badge bg-success':
                                            modalReview.status === 'approved',
                                        'badge bg-danger':
                                            modalReview.status === 'rejected',
                                    }"
                                    >{{ modalReview.status }}</span
                                >
                            </div>
                            <div class="mb-2">
                                <strong>Reported:</strong>
                                <span
                                    v-if="modalReview.reported"
                                    class="badge bg-danger"
                                    >Yes</span
                                ><span v-else class="badge bg-secondary"
                                    >No</span
                            ...
                            <div class="mb-2" v-if="modalReview.reported">
                                <strong>Report Reason:</strong>
                                {{ modalReview.report_reason }}
                            </div>
                            <div class="mb-2">
                                ...
                                <textarea
                                    ...
                                    :readonly="modalReview.status !== 'pending'"
                                ></textarea>
                            </div>
                            <div class="mb-2">
                        ...
                        <div class="modal-footer">
                            <button
                                ...
                                :disabled="modalReview.status !== 'pending'"
                            >
                                Approve
                            </button>
                            <button
                            ...
                            <button
                                ...
                                @click="() => handleModalAction('dismiss')"
                                :disabled="!modalReview.reported"
                            >
                                Dismiss Report
                            </button>
                            <button
