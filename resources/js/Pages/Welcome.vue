  ...
  <GuestLayout>
    ...
    <section class="welcome-hero d-flex align-items-center justify-content-center text-center position-relative overflow-hidden">
      ...
      <div class="hero-content">
        <div class="mb-4">
          <span class="hero-icon bg-white bg-opacity-75 rounded-circle shadow-sm mb-3 animate-pop-in">
            <i class="fa-solid fa-book fa-3x text-success" aria-hidden="true"></i>
          </span>
          <h1 class="display-3 fw-bold mb-2 animate-slide-up">Welcome to <span class="text-success">eBaryo Library</span></h1>
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-center gap-4 animate-slide-up" style="animation-delay:0.4s">
          <Link href="/login" class="btn btn-success btn-lg px-5 shadow-sm btn-glow">Login</Link>
          <Link href="/register" class="btn btn-outline-success btn-lg px-5 shadow-sm btn-glow">Register</Link>
        </div>
      </div>
    ...
    <section class="container-fluid py-5">
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-4 text-center">
        <div class="col animate-on-scroll">
          <div class="feature-card p-4 h-100 rounded-4 shadow-sm bg-white">
            <img src="/book_icons/story_books.png" alt="Story Books" class="mb-3" style="width:48px; height:48px;" />
            <h5 class="fw-semibold mb-2">Story Books</h5>
            <p class="text-muted small mb-0">Enjoy a variety of story books for all ages.</p>
          </div>
        </div>
        <div class="col animate-on-scroll">
          <div class="feature-card p-4 h-100 rounded-4 shadow-sm bg-white">
            <img src="/book_icons/educational.png" alt="Educational Books" class="mb-3" style="width:48px; height:48px;" />
            <h5 class="fw-semibold mb-2">Educational</h5>
            <p class="text-muted small mb-0">Access textbooks and learning materials.</p>
          </div>
        </div>
        <div class="col animate-on-scroll">
          <div class="feature-card p-4 h-100 rounded-4 shadow-sm bg-white">
            <img src="/book_icons/agriculture.png" alt="Agriculture & Livelihood" class="mb-3" style="width:48px; height:48px;" />
            <h5 class="fw-semibold mb-2">Agriculture</h5>
            <p class="text-muted small mb-0">Resources for sustainable farming and livelihood.</p>
          </div>
        </div>
        <div class="col animate-on-scroll">
          <div class="feature-card p-4 h-100 rounded-4 shadow-sm bg-white">
            <img src="/book_icons/cultural.png" alt="Cultural Heritage" class="mb-3" style="width:48px; height:48px;" />
            <h5 class="fw-semibold mb-2">Cultural Heritage</h5>
            <p class="text-muted small mb-0">Preserve and explore local culture and history.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="why-choose-us-section py-5 bg-light">
      <div class="container">
        <h2 class="text-center fw-bold mb-5 animate-on-scroll">Why Choose <span class="text-success">eBaryo Library</span>?</h2>
        <div class="row g-4 justify-content-center">
          <div class="col-12 col-md-4 animate-on-scroll">
            <div class="choose-card p-4 rounded-4 shadow-sm h-100 text-center bg-white">
              <i class="fa-solid fa-globe fa-2x text-success mb-3" aria-hidden="true"></i>
              <h5 class="fw-semibold mb-2">Accessible Anywhere</h5>
              <p class="text-muted small mb-0">Read and learn from any device, anytime, anywhere.</p>
            </div>
          </div>
          <div class="col-12 col-md-4 animate-on-scroll">
            <div class="choose-card p-4 rounded-4 shadow-sm h-100 text-center bg-white">
              ...
              <p class="text-muted small mb-0">Built for and by the community, supporting local growth.</p>
            </div>
          </div>
          <div class="col-12 col-md-4 animate-on-scroll">
            <div class="choose-card p-4 rounded-4 shadow-sm h-100 text-center bg-white">
              <i class="fa-solid fa-shield-halved fa-2x text-success mb-3" aria-hidden="true"></i>
              <h5 class="fw-semibold mb-2">Safe & Secure</h5>
              <p class="text-muted small mb-0">Your data and reading experience are always protected.</p>
            </div>
          </div>
        </div>
      </div>
