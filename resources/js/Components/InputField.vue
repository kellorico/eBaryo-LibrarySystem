...
<template>
  <div class="mb-3">
    <label :for="props.id" class="form-label fw-semibold text-success">{{ props.label }}</label>
    ...
    <div v-if="props.error" class="invalid-feedback text-danger fw-semibold error-animate error-below-input" style="display:block;">
      {{ props.error }}
    </div>
  </div>
</template>
