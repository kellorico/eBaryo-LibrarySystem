...
<template>
    <button
        :type="type"
        class="btn btn-success-green w-100 d-flex justify-content-center align-items-center btn-ripple"
        :disabled="disabled"
    >
        <span
            v-if="isLoading"
            class="spinner-border spinner-border-sm me-2 spinner-green"
            role="status"
            aria-hidden="true"
        ></span>
        <slot />
...
.btn-success-green:focus {
    ...
    box-shadow: 0 6px 24px #43c59e33, 0 2px 8px #19875422;
